...
const useReportTools = (): ReportTool[] => {
    ...
    const reportTools = useMemo(
        () => [
            ...
            { type: "edit", name: toolNames.edit, imgSrc: EditGeomImg, order: 0, title: t("edit_title") },
            { type: "edit", name: toolNames.display, imgSrc: EditStyleImg, order: 1, title: t("edit_title") },
